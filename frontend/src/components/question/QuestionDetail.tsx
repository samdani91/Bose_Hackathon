          ...
          <CardContent className="p-0">
            <div className="flex flex-col md:flex-row">
              ...
              <div className="md:p-6 p-4 flex md:flex-col flex-row justify-center items-center md:w-24 bg-slate-50/80 md:border-r border-b md:border-b-0 border-slate-200/50">
                <button 
                  className={`rounded-full p-2 transition-all ${voteStatus === 'up' ? 'bg-emerald-100 text-emerald-600 shadow-inner' : 'text-slate-400 hover:bg-slate-100 hover:text-emerald-500'}`}
                ...
                <div className="hidden md:flex md:flex-col items-center mt-6 space-y-3">
                  <button 
                    className={`rounded-full p-2 transition-all ${isBookmarked ? 'bg-amber-100 text-amber-500 shadow-inner' : 'text-slate-400 hover:bg-slate-100 hover:text-amber-500'}`}
                    onClick={() => setIsBookmarked(!isBookmarked)}
                    aria-label="Bookmark question"
                  >
                    <Bookmark className="h-5 w-5" />
                  </button>
                  <button className="rounded-full p-2 text-slate-400 hover:bg-slate-100 hover:text-indigo-500 transition-all" aria-label="Share question">
                    <Share2 className="h-5 w-5" />
                  </button>
                  <button className="rounded-full p-2 text-slate-400 hover:bg-slate-100 hover:text-rose-500 transition-all" aria-label="Report question">
              ...
              <div className="flex-1 p-6 bg-white">
                ...
                <div className="mt-4 pt-4 border-t border-slate-200/50">
                  <div className="flex justify-between items-center mb-3">
                    ...
                    <button className="text-xs bg-indigo-50 text-indigo-600 hover:bg-indigo-100 px-3 py-1 rounded-full transition-colors">
                      Add a comment
                    </button>
                  </div>
                  
                  {/* Comment list placeholder */}
                  <div className="text-sm text-slate-500 italic p-3 bg-slate-50/50 rounded-lg border border-dashed border-slate-200">
